...
class CNN:
	...
	def create_data_sets(self):
		path = "/home/fizzer/train_cnn/p_id_training/adjusted_data"
	...
	def create_val_data(self):
		path = "/home/fizzer/train_cnn/p_id_training/val_data"
		labels = os.listdir(path)
	...
	def neural_net(self, X_train_dataset, Y_train_dataset, X_val_dataset, Y_val_dataset):
		...
		history_conv = conv_model.fit(X_train_dataset, Y_train_dataset, 
                              ...
                              batch_size=16)
		print(history_conv)
		conv_model.save('/home/fizzer/train_cnn/p_id_training/p_id_model')
