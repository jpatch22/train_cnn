...
class Data_Gen_Num:
	def __init__(self):
		files = os.listdir("/home/fizzer/train_cnn/p_id_training/adjusted_data")
		for file in files:
			os.remove("/home/fizzer/train_cnn/p_id_training/adjusted_data/" + file)
	...
	def copy(self):
		for tag, image in self.images:
			cv2.imwrite(os.path.join("/home/fizzer/train_cnn/p_id_training/adjusted_data/", 
		                             "{}.png".format(tag)),
		                             image)
